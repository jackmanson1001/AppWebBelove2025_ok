...
<head>
    <link rel="shortcut icon" type="image/png" href="<?php echo base_url;?>Assets/img/iso_logo.png"/>
    ...
    <meta property="og:site_name" content="Belove">
    <meta property="og:title" content="Vali - Free Bootstrap 4 admin theme">
    <!-- <meta property="og:url" content="http://pratikborsadiya.in/blog/vali-admin"> -->
    <!-- <meta property="og:image" content="http://pratikborsadiya.in/blog/vali-admin/hero-social.png"> -->
    <meta property="og:description" content="Belove es una app para gestionar la atencion al cliente.">
...
<body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?php echo base_url; ?>Configuracion/admin">Belove</a>
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-list"></i><span class="app-menu__label">Mantenimientos</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                    ...
                    <li><a class="treeview-item" href="<?php echo base_url; ?>Sexo"><i class="icon fa fa-book"></i> Sexo</a></li>
                    <li><a class="treeview-item" href="<?php echo base_url; ?>Cargo"><i class="icon fa fa-book"></i> Cargo</a></li>
                    <li><a class="treeview-item" href="<?php echo base_url; ?>Documento"><i class="icon fa fa-book"></i> Documento</a></li>
                    <li><a class="treeview-item" href="<?php echo base_url; ?>Producto"><i class="icon fa fa-book"></i> Producto</a></li>
                    <li><a class="treeview-item" href="<?php echo base_url; ?>TipoReserva"><i class="icon fa fa-book"></i> Tipo Reserva</a></li>
                    <li><a class="treeview-item" href="<?php echo base_url; ?>Servicio"><i class="icon fa fa-book"></i> Servicio</a></li>
                    <li><a class="treeview-item" href="<?php echo base_url; ?>Empleado"><i class="icon fa fa-book"></i> Empleado</a></li>
                </ul>
            </li>
